  ...
  <section class="terms">
    <div class="terms_wrapper">
      <div class="terms_header">
        <h1 class="terms_title">Website Terms and Conditions</h1>
        <p class="terms_date">Last updated: May, 29 2025</p>
      </div>

      <div class="terms_content">
        <div class="policy_intro">
          <p>These Website Terms and Conditions (hereinafter – the "Terms") govern access to and use of website <a href="https://fincord.tech/" target="_blank">https://fincord.tech/</a> (the "Website") by the users (hereinafter – the "User", "You", "Your"), which is owned and operated by Fincord ("Fincord", "We", "Us", "Our). By accessing or using the Website You confirm that you have read, understood and agree to be bound by these Terms and all policies referenced herein and/or presented on the Website. If You do not agree, You must refrain from using the Website.</p>
        </div>

        <div class="section">
          <h2 class="section_title">1. USE OF THE WEBSITE</h2>
          
          <div class="subsection">
            <p><strong>1.1.</strong> The Website is provided for informational purposes only and presents Fincord's technology solutions and product offerings. Use of the Website does not require user registration, and no login functionality is currently provided to the public.</p>
          </div>

          <div class="subsection">
            <p><strong>1.2.</strong> You may browse and interact with the Website solely for lawful purposes and in accordance with these Terms.</p>
          </div>

          <div class="subsection">
            <p><strong>1.3.</strong> The Website is intended exclusively for persons who are 18 years of age or older. By accessing the Website, You warrant that You are at least 18 years old and possess the legal capacity to enter into binding contracts under the law applicable to You. The Website is not directed at minor (persons under 18 years of age) and We do not knowingly collect personal data from children.</p>
          </div>
        </div>

        <div class="section">
          <h2 class="section_title">2. PERMITTED USE AND ACCEPTABLE CONDUCT</h2>
        ...
        <div class="section">
          <h2 class="section_title">3. INTELLECTUAL PROPERTY</h2>
          
          <div class="subsection">
            <p><strong>3.1.</strong> All content and materials displayed or made available on the Website, including but not limited to text, graphics, visual interfaces, logos, trademarks, design, layout, software code, and underlying technology (collectively, "Content"), are the exclusive property of Fincord or its licensors and are protected by applicable intellectual property and copyright laws.</p>
          </div>
        ...
        <div class="section">
          <h2 class="section_title">4. PROHIBITED USE</h2>
          ...
          <div class="subsection">
            <p><strong>4.2.</strong> Any unauthorized use of the Website or content may result in legal action and/or immediate termination of access.</p>
          </div>
        </div>

        <div class="section">
          <h2 class="section_title">5. NO OFFER OR ADVICE</h2>
          
          <div class="subsection">
            <p><strong>5.1.</strong> The Content is provided for general information purposes only. Nothing on the Website constitutes or is intended to constitute: (i) an offer, solicitation or invitation to invest in, purchase or subscribe for any financial instrument or service; (ii) legal, tax, accounting, financial or investment advice; or (iii) a recommendation regarding any financial product or service. You should obtain independent professional advice before making any decision based on information obtained from the Website.</p>
          </div>
        </div>
